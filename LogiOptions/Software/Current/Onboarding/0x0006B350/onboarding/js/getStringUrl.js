...
var website = "logitech.com/options";
        ...
        function loadDefaultScript()
        {
            try
            {
                ...
                brand   = ( ( logicool == true ) || locale.endsWith("-JP") ) ? "Logicool" : "Logitech";
                website = ( ( logicool == true ) || locale.endsWith("-JP") ) ? "logicool.co.jp/ja-jp/product/options" : "logitech.com/options";
